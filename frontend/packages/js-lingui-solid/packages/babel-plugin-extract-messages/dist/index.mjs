...
function linguiExtractMessages({ types: t }) {
  function isTransComponent(path) {
    return path.isJSXElement() && (path.get("openingElement").get("name").referencesImport("@lingui/react", "Trans") || path.get("openingElement").get("name").referencesImport("@lingui-solid/solid", "Trans"));
  }
...
export { linguiExtractMessages as default };
