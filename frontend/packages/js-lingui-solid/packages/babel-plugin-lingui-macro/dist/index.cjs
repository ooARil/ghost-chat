...
const ast = require('./shared/babel-plugin-lingui-macro.872807cd.cjs');
...
class MacroJSX {
  constructor({ types }, opts) {
    ...
    __publicField$1(this, "isLinguiComponent", (path, name) => {
      ...
      return identifier.referencesImport(ast.MACRO_REACT_PACKAGE, name) || identifier.referencesImport(ast.MACRO_SOLID_PACKAGE, name) || identifier.referencesImport(ast.MACRO_LEGACY_PACKAGE, name);
    });
