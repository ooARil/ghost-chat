import { m as makeCounter, c as createMessageDescriptorFromTokens, M as MsgDescriptorPropKey, b as MACRO_REACT_PACKAGE, d as MACRO_SOLID_PACKAGE, e as MACRO_LEGACY_PACKAGE, a as JsxMacroName, f as createMacroJsContext, t as tokenizeTemplateLiteral, p as processDescriptor, i as isDefineMessage, g as isLinguiIdentifier, J as JsMacroName, h as tokenizeNode, j as MACRO_CORE_PACKAGE } from './shared/babel-plugin-lingui-macro.bfbb56b7.mjs';
...
class MacroJSX {
  constructor({ types }, opts) {
    ...
    __publicField$1(this, "isLinguiComponent", (path, name) => {
      ...
      return identifier.referencesImport(MACRO_REACT_PACKAGE, name) || identifier.referencesImport(MACRO_SOLID_PACKAGE, name) || identifier.referencesImport(MACRO_LEGACY_PACKAGE, name);
    });
